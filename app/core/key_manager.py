...
PROVIDERS = {
    "openai": {
        ...
        "desc": "2026.07 最新：GPT-4.1 系列 + o4-mini 推理模型",
        "pricing": "4.1 $2/$8, 4.1-mini $0.4/$1.6, o4-mini $1.1/$4.4 per 1M",
    },
    "claude": {
        ...
        "desc": "2026.07 最新：Opus 4.7 编程顶级，Sonnet 4.6 性价比之王",
    ...
    "deepseek": {
        ...
        "desc": "2026.07 最新：V4 Pro 编程推理顶级，V4 Flash 性价比极高",
        "pricing": "V4-Pro ¥2/¥8, V4-Flash ¥0.5/¥2 per 1M",
    },
    "qwen": {
        "name": "通义千问 (Qwen)",
        ...
        "models": [
            ...
            "qwen3-coder-plus", "qwen-vl-max",
        ],
        "desc": "2026.07 最新：Qwen3 235B 开源最强 MoE，VL 多模态",
        "pricing": "Turbo 免费，Plus ¥0.8, Max ¥2/1M",
    },
    "ollama": {
        "name": "Ollama 本地模型",
        ...
        "models": [
            ...
            "deepseek-v4:latest",
            "llama4:latest", "gemma3:12b",
            "mistral:7b", "phi4:14b",
        ],
        "desc": "2026.07 最新：支持 Qwen3/DeepSeek-V4/Llama4/Gemma3",
    ...
    "zhipu": {
        ...
        "desc": "2026.07 最新：GLM-4.5 系列 + Z1 免费推理，4.5V 多模态",
    ...
    "baidu": {
        ...
        "desc": "2026.07 最新：ERNIE 4.5 Turbo 128K，4.5V 多模态视觉",
    ...
    "xunfei": {
        ...
        "models": ["spark4.0-ultra", "spark-max", "spark-pro", "spark-lite"],
        "desc": "2026.07 最新：Spark4.0 Ultra 推理能力大幅提升",
    ...
    "hunyuan": {
        ...
        "desc": "2026.07 最新：Turbo S 极速推理，T1 深度思考",
    ...
    "moonshot": {
        ...
        "desc": "2026.07 最新：Kimi K2 旗舰，Thinking 深度推理模式",
        "pricing": "K2 ¥0.06, V1 ¥0.012/1K tokens",
    },
    "minimax": {
        "name": "MiniMax (ABAB)",
        ...
        "desc": "2026.07 最新：ABAB7 最新旗舰，中文对话流畅自然",
        "pricing": "6.5s ¥0.001, 6.5 ¥0.005, 7 ¥0.01/1K",
    },
    "baichuan": {
        "name": "百川智能 (Baichuan)",
        ...
        "desc": "2026.07 最新：Baichuan4 Turbo 速度快，医疗+工业优化",
        "pricing": "Air ¥0.001, Turbo ¥0.003/1K",
    },
    "lingyi": {
        "name": "零一万物 (Yi)",
        "default_model": "yi-turbo",
        "default_url": "https://api.lingyiwanwu.com/v1",
        "models": ["yi-turbo", "yi-large", "yi-medium", "yi-vision"],
        "desc": "2026.07 最新：Yi-Vision 多模态视觉理解，Turbo 高速",
        "pricing": "Large ¥0.025, Turbo ¥0.003/1K",
    },
    "doubao": {
        "name": "字节豆包 (Doubao)",
        ...
        "models": [
            ...
            "doubao-seed-1.6-lite", "doubao-pro-128k",
        ],
        "desc": "2026.07 最新：Seed 1.6 架构，Flash 极速推理 128K",
        "pricing": "Lite ¥0.0008, Flash ¥0.004/1K",
    },
    "xiaomi": {
        "name": "小米 (MiLM)",
        "default_model": "milm-2.5",
        "default_url": "https://api.xiaomimlm.com/v1",
        "models": ["milm-2.5", "milm-2.5-turbo", "milm-2.5-mini"],
        "desc": "2026.07 最新：MiLM 2.5 多模态+端侧部署，小爱同学同源",
        "pricing": "Mini 免费，Turbo ¥0.001/1K",
    },
}
